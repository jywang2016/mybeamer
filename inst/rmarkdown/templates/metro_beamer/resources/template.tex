...
\setbeamercolor{palette quaternary}{fg=sthlmDarkGrey, bg=sthlmLightGrey}
...
\setbeamercolor{itemize item}{fg=sthlmDarkGrey}
\setbeamercolor{itemize subitem}{fg=sthlmDarkGrey}
...
%\frame[plain]{\titlepage}
{
	...
	\AddToShipoutPictureFG*{
		\AtPageLowerRight{\put(-120, 0){
			\includegraphics[width=.2\paperwidth]{logo.png}}}}
...
\begin{frame}[plain]
\centering
\vfill\usebeamerfont{section title}\textcolor{sthlmDarkGrey}{\insertsectionHEAD}\vfill
\end{frame}
\endgroup
}
\fi
...
%    \multiply\progressbar@tmpdim by 100
  \begin{tikzpicture}[very thin]
    ...
    \shade[top color=sthlmDarkGrey,bottom color=sthlmDarkGrey,middle color=sthlmDarkGrey]
...
\setbeamertemplate{headline}{
  ...
  \begin{beamercolorbox}[wd=\paperwidth,ht=0ex,center,dp=0ex]{sthlmDarkGrey}%
